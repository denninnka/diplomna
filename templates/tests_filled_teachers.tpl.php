    ...
    <div class="panel-heading" role="tab" id="heading<?=$test['ID_polojen'];?>">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?=$test['ID_polojen'];?>" aria-expanded="true" aria-controls="collapse<?=$test['ID_polojen'];?>">
         <?=$test['data'];?> &nbsp&nbsp<?=$test['ime_test'];?> &nbsp&nbsp<?=$test['ime_uchenik'];?>
        </a>
      </h4>
    </div>
    ...
    <div id="collapse<?=$test['ID_polojen'];?>" class="panel-collapse collapse " role="tabpanel" aria-labelledby="heading<?=$test['ID_polojen'];?>">
      <div class="panel-body">
        ...
        <form class="form-horizontal" action="" method="POST">
          ...
          <div class="form-group">
  		      <label class="col-sm-2 control-label">Ученик : </label>
    		      <div class="col-sm-10">
                <h4><?=$test['ime_uchenik'];?></h4>
    		      </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">       
              <button type="submit" class="btn btn-primary" name="submit_recenz" value="<?=$test['ID_polojen'];?>">Изпрати рецензия</button>
            </div>            
          </div>
          <input type="hidden" name="ID_polojen" value="<?=$test['ID_polojen'];?>">
          <?php } ?>
        </form>
      </div>
    </div>
